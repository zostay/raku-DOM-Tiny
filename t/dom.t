...
# is $dom->at('#â˜ƒx')->text,                           'Snowman', 'right text';
# is $dom->at('div#â˜ƒx')->text,                        'Snowman', 'right text';
# is $dom->at('html div#â˜ƒx')->text,                   'Snowman', 'right text';
# is $dom->at('[id^="â˜ƒ"]')->text,                     'Snowman', 'right text';
# is $dom->at('div[id^="â˜ƒ"]')->text,                  'Snowman', 'right text';
# is $dom->at('html div[id^="â˜ƒ"]')->text,             'Snowman', 'right text';
# is $dom->at('html > div[id^="â˜ƒ"]')->text,           'Snowman', 'right text';
# is $dom->at('[id^=â˜ƒ]')->text,                       'Snowman', 'right text';
# is $dom->at('div[id^=â˜ƒ]')->text,                    'Snowman', 'right text';
# is $dom->at('html div[id^=â˜ƒ]')->text,               'Snowman', 'right text';
...
# is $dom->at('.â™¥')->text,                            'Heart',   'right text';
# is $dom->at('html .â™¥')->text,                       'Heart',   'right text';
# is $dom->at('div.â™¥')->text,                         'Heart',   'right text';
# is $dom->at('html div.â™¥')->text,                    'Heart',   'right text';
# is $dom->at('[class$="â™¥"]')->text,                  'Heart',   'right text';
# is $dom->at('div[class$="â™¥"]')->text,               'Heart',   'right text';
# is $dom->at('html div[class$="â™¥"]')->text,          'Heart',   'right text';
# is $dom->at('html > div[class$="â™¥"]')->text,        'Heart',   'right text';
# is $dom->at('[class$=â™¥]')->text,                    'Heart',   'right text';
# is $dom->at('div[class$=â™¥]')->text,                 'Heart',   'right text';
# is $dom->at('html div[class$=â™¥]')->text,            'Heart',   'right text';
...
# is $dom->at('#â˜ƒx')->parent,     $html, 'right result';
# is $dom->at('#â˜ƒx')->root,       $html, 'right result';
